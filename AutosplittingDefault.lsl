...
<Layout version="1.6.1">
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>R:\files\speedrun\Livesplit\autosplitter\HTTQ_AutosplitterV1\HypeTheTimeQuest_Universal_Autosplitter.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="NoSplits" type="bool">False</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
